...
const preferredFields: Record<PhaseCode, string[]> = {
  ...
  PRD: ['markdownDraft', 'contentPackDraft', 'experienceDirectionDraft', 'uiBriefDraft', 'uiReviewDraft', 'uiReviewResolution', 'uiReviewApplied'],
