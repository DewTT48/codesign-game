...
const preferredFields: Record<PhaseCode, string[]> = {
  ...
  PRD: ['markdownDraft', 'contentPackDraft', 'experienceDirectionDraft', 'uiBriefDraft', 'uiReviewDraft', 'uiReviewResolution', 'uiReviewChangeSummary', 'uiReviewApplied'],
...
const markdownFields = new Set(['markdownDraft', 'contentPackDraft', 'experienceDirectionDraft', 'uiBriefDraft', 'uiReviewDraft', 'uiReviewResolution'])
