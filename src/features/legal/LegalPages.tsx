  ...
  if (!isThai) {
    return (
      <LegalLayout code="DATA & PRIVACY" title="PRIVACY POLICY" summary="CODESIGN collects only the information needed for sign-in, saving your product journey, and continuing your work later.">
        <section><h2>1. INFORMATION CODESIGN COLLECTS</h2><p>When you sign in with Google, CODESIGN receives the name, email address, profile image, and basic account identifier that Google permits through OAuth. CODESIGN never receives your Google password.</p><p>While you use the app, we store the information you enter in a project, including Context, Options, Decisions, Specification, PRD, build URLs, Feedback, and Next Iteration.</p></section>
        ...
        <section><h2>3. SERVICES THAT PROCESS DATA</h2><ul><li><strong>Google OAuth</strong> — sign-in and basic profile information.</li><li><strong>Supabase</strong> — authentication and your private database records.</li><li><strong>GitHub Pages</strong> — hosting the CODESIGN frontend.</li></ul><p>These providers process information under their own policies and terms.</p></section>
        ...
        <section><h2>6. RETENTION, ACCESS & DELETION</h2><p>Information is retained so you can continue a Guided Build later. You can revoke the Google connection in your Google Account settings. To request a copy or deletion, contact the administrator through the <a href="https://github.com/DewTT48/codesign-game/issues" target="_blank" rel="noreferrer">CODESIGN repository</a>, ask for a private contact channel, and do not post your email address or project content in a public issue.</p></section>
  ...
  if (!isThai) {
    return (
      <LegalLayout code="SERVICE RULES" title="TERMS OF USE" summary="These terms describe the scope of CODESIGN as a learning tool for structuring product decisions.">
        ...
        <section><h2>2. YOUR ACCOUNT & CONTENT</h2><p>You are responsible for securing the Google account used to sign in and for the content you enter. Avoid storing secrets, health or financial information, or another person&apos;s personal information unless it is necessary for the product journey.</p></section>
