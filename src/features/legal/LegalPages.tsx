...
export function PrivacyPage() {
  ...
  if (!isThai) {
    return (
      <LegalLayout code="DATA & PRIVACY" title="PRIVACY POLICY" summary="CODESIGN collects only the information needed for sign-in, saving your product journey, and continuing your work later.">
        ...
        <section><h2>2. HOW THE INFORMATION IS USED</h2><ul><li>Authenticate you and keep each user&apos;s projects separate.</li><li>Save and restore your Guided Build or Build Your Own journey.</li><li>Consolidate your inputs and decisions into a PRD and CODESIGN Project Record.</li><li>Maintain security, support users, and review the quality of the product journey.</li><li>Provide authorized administrators with the account, project, progress, and Project Record information needed to operate and support the service.</li></ul></section>
        ...
        <section><h2>4. STORAGE & SECURITY</h2><p>Project data is stored in Supabase and protected by Row Level Security so a signed-in account can read and change only its own records. The publishable key in the frontend cannot bypass these policies.</p><p>Authorized administrators can use the read-only Admin Dashboard to review account information and complete Project Records, including C–N inputs, Decisions, PRDs, build evidence, feedback, and AI proposals. Admins cannot edit or lock a project on the owner&apos;s behalf through this view. Opening a Project Record is recorded in an Admin access log.</p></section>
  ...
  return (
    <LegalLayout code="DATA & PRIVACY" title="PRIVACY POLICY" summary="CODESIGN เก็บข้อมูลเท่าที่จำเป็นเพื่อให้ผู้ใช้เข้าสู่ระบบ บันทึก Product journey และกลับมาทำงานต่อได้">
      ...
      <section><h2>2. HOW THE INFORMATION IS USED</h2><ul><li>ยืนยันตัวตนและแยก Project ของผู้ใช้แต่ละคน</li><li>บันทึกและกู้คืน Journey ทั้ง Guided Build และ Build Your Own</li><li>Consolidate ข้อมูลและการตัดสินใจเป็น PRD และ CODESIGN Project Record</li><li>รักษาความปลอดภัย สนับสนุนผู้ใช้ และตรวจสอบคุณภาพของ Product journey</li><li>แสดงข้อมูลบัญชี Project ความคืบหน้า และ Project Record แก่ผู้ดูแลระบบที่ได้รับสิทธิ์ เพื่อใช้ดูแลและสนับสนุนบริการ</li></ul></section>
      ...
      <section><h2>4. STORAGE & SECURITY</h2><p>ข้อมูล Project ถูกจัดเก็บใน Supabase และป้องกันด้วย Row Level Security เพื่อให้บัญชีที่เข้าสู่ระบบอ่านและแก้ไขได้เฉพาะข้อมูลของตนเอง Publishable key ที่อยู่ใน Frontend ไม่สามารถข้ามนโยบายนี้ได้</p><p>ผู้ดูแลระบบที่ได้รับสิทธิ์สามารถใช้ Admin Dashboard แบบอ่านอย่างเดียวเพื่อดูข้อมูลบัญชีและ Project Record ทั้งหมด ได้แก่ข้อมูล C–N, Decisions, PRD, หลักฐานการ Build, Feedback และ AI Proposal โดย Admin ไม่สามารถแก้คำตอบหรือ Lock Step แทนเจ้าของ Project ผ่านมุมมองนี้ และระบบจะบันทึกการเปิด Project ไว้ใน Admin access log</p></section>
      ...
      <section><h2>6. RETENTION, ACCESS & DELETION</h2><p>ข้อมูลจะถูกเก็บเพื่อให้คุณกลับมาทำ Project ต่อได้ คุณสามารถเก็บ Project เข้าคลังจาก Dashboard และลบ Project นั้นถาวรจากรายการ Archived การลบจะครอบคลุมข้อมูล การตัดสินใจ PRD และ Project Record ที่เกี่ยวข้องทั้งหมด คุณยังสามารถเพิกถอนการเชื่อมต่อ Google ได้จาก Google Account settings หากต้องการเข้าถึงหรือลบข้อมูลระดับบัญชี ให้ติดต่อผู้ดูแลผ่าน <a href="https://github.com/DewTT48/codesign-game/issues" target="_blank" rel="noreferrer">CODESIGN repository</a> โดยขอช่องทางติดต่อแบบส่วนตัวและอย่าโพสต์อีเมลหรือเนื้อหา Project ลงใน Public Issue</p></section>
...
export function TermsPage() {
  ...
  if (!isThai) {
    return (
      <LegalLayout code="SERVICE RULES" title="TERMS OF USE" summary="These terms describe the scope of CODESIGN as a learning tool for structuring product decisions.">
        ...
        <section><h2>5. AVAILABILITY & CHANGES</h2><p>The service may change, pause, or end during development. Download important PRDs and Project Records to keep your own copies.</p></section>
  ...
  return (
    <LegalLayout code="SERVICE RULES" title="TERMS OF USE" summary="เงื่อนไขนี้อธิบายขอบเขตการใช้ CODESIGN ในฐานะเครื่องมือเรียนรู้และจัดโครงสร้างการตัดสินใจด้าน Product">
      ...
      <section><h2>5. AVAILABILITY & CHANGES</h2><p>บริการอาจเปลี่ยน หยุดชั่วคราว หรือยุติได้ระหว่างการพัฒนา ผู้ใช้ควรดาวน์โหลด PRD และ Project Record ที่สำคัญเพื่อเก็บสำเนาของตนเอง</p></section>
